...
export const HotelEditComponentInner = (props: Props) => {
  const { classes, hotel, cities, onFieldUpdate, formErrors, onSave } = props;
  ...
  return (
    <div className={classes.formContainer}>
      ...
      <DropdownForm name="city" label="city"
        onChange={onFieldUpdate}
        value={hotel.city}
        list={cities}
      ...
      <TextAreaForm placeholder="Description" name="description" label="description"
